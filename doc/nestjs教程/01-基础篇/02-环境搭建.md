...
1. **Vscode NestJs Snippets**: 提供 NestJS 代码片段，快速生成控制器、服务、模块等代码。
2. **ESLint**: 代码质量检查工具，帮助你遵循代码规范。
3. **Prettier**: 代码格式化工具，保持代码风格一致。
4. **API测试工具推荐**: 推荐使用 Apifox 或 Postman 进行 API 测试和管理，这两个工具提供了更全面的 API 测试功能、团队协作支持和文档生成能力。
   - **Apifox**: 一体化 API 协作平台，集 API 设计、文档、测试、Mock 于一体
   - **Postman**: 功能强大的 API 测试和协作平台，支持各种 API 测试场景
5. **Docker**: Docker 支持，方便部署和运行应用。
