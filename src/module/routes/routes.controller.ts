...
export class RoutesController {
  ...
  @ApiOkResponse({ type: RouteResponseDto, description: '创建路由成功' })
  ...
  @ApiOkResponse({ type: [RouteResponseDto], description: '查询所有路由成功' })
  findAll(
  ...
  @ApiOkResponse({ type: RouteResponseDto, description: '获取路由详情成功' })
  ...
  @ApiOkResponse({ type: RouteResponseDto, description: '修改路由信息成功' })
