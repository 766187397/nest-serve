...
import { ScheduleResponseDto, ScheduleLogResponseDto } from './dto/response.dto';
...
export class ScheduleController {
  ...
  @ApiOkResponse({ type: ScheduleResponseDto, description: '创建定时任务成功' })
  ...
  @ApiOkResponse({ type: [ScheduleResponseDto], description: '查询定时任务列表成功' })
  findByPage(
  ...
  @ApiOkResponse({ type: ScheduleResponseDto, description: '查询定时任务详情成功' })
  ...
  @ApiOkResponse({ type: ScheduleResponseDto, description: '更新定时任务成功' })
  ...
  @ApiOkResponse({ type: ScheduleResponseDto, description: '启用/禁用定时任务成功' })
  ...
  @ApiOkResponse({ type: ScheduleResponseDto, description: '手动执行定时任务成功' })
  ...
  @ApiOkResponse({ type: [ScheduleLogResponseDto], description: '查询定时任务执行日志成功' })
  findLogsByPage(
    @Headers('x-platform') platform: string,
    @Param('id') id: string,
