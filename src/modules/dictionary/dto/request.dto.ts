...
/** 分页查询字典分类请求DTO */
export class FindDictionaryDtoByPage extends PartialType(IntersectionType(FindDictionaryDto, PageByParameter)) {}
...
/** 分页查询字典项请求DTO */
export class FindDictionaryItemDtoByPage extends PartialType(IntersectionType(FindDictionaryItemDto, PageByParameter)) {}
